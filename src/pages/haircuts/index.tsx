...
export default function Haircuts({haircuts}: HaircutsProps){
    ...
    async function handleDisebled(e: ChangeEvent<HTMLInputElement>){
                ...
                <Flex direction="column" alignItems="flex-start" justifyContent="flex-start">
                    ...
                    >
                        ...
                        <Link href="/haircuts/new">
                            <Button bg='gray.700' _hover={{background: 'gray.700'}} color='#fff'>
                                Cadastrar novo
                            </Button>
                        </Link>
                        ...
                        <Stack ml="auto" align='center' direction='row'>
                            ...
                            <Switch
                                ...
                                onChange={(e: ChangeEvent<HTMLInputElement>) => handleDisebled(e) }
                    ...
                    {haircutList.map(haircut => (
                        ...
                        >
                            <Flex mb={isMobile ? 2 : 0} direction='row' alignItems='center' justifyContent='center'>
                                ...
                                <Text fontWeight='bold' color='white' ml={4} noOfLines={4} > {haircut.name} </Text>
                            </Flex>
